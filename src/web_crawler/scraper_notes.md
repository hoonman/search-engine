...
* We must add respecting the delay code because i'm getting status 429 after a little while from plrg.ics.uci.edu we must add a specific delay
* time the start and end (how long did the crawler take? ), how many urls ? 
* 
